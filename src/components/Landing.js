  ...
  return (
    <section id="landing" className="h-screen gradient shadow-xl">
      <div className="container mx-auto flex px-10 pb-20 md:flex-row flex-col items-center justify-center h-full">
        <div className="lg:flex-grow flex flex-col mb-16 md:mb-0 lg:items-start items-center text-left w-full">
          <Fade cascade>
            <p className="md:text-2xl sm:text-xl font-medium text-white bg-white bg-opacity-20 transform md:-skew-x-12 md:rounded-none rounded-md md:shadow-none shadow-md md:px-3 px-2">// Nice to meet you, I'm</p>
          </Fade>
          ...
          <Fade cascade>
            <div className="md:text-2xl sm:text-xl w-full mb-4 font-medium text-white bg-white bg-opacity-20 transform md:-skew-x-12 md:rounded-none rounded-md md:shadow-none shadow-md md:px-3 px-2 md:text-left text-left">// Software developer with experience in full stack development, defect tracking, and database management</div>
          </Fade>
          <Fade cascade>
